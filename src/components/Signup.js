...
function CheckValidity(props) {
  ...
  else if (props.unvalid === "pass")
    return <p> The passwords doesn't match </p>;
  else return <p />;
}
...
export default class Signup extends Component {
  ...
  render() {
    let modalText = this.state.unvalid === "missing" ? <p>Missing data</p> : <p>Your passwords don't match</p>
