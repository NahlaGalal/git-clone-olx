...
const About = () => (
  <main className="about container">
    ...
    <p>
      Hi, this is just a simple project we created as part of our learning path
      to implement SQL databases, we created a small web app to help people sell
      their used items that they don't need anymore, and earn a little extra
      cash for it. It's just a small piece to experiment with our skills.
